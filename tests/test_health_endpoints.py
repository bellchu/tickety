...
class HealthEndpointTests(unittest.TestCase):
    ...
    def test_production_portal_config_links_to_the_provider_portal(self):
        adapter = type("Adapter", (), {
            "provider_name": "freshservice",
            "domain": "support.example.com",
        })()
        with (
            patch.object(main.settings_module, "app_mode", return_value="production"),
            patch(
        ...
        self.assertEqual(
            ...
            {
                "mode": "production",
                "support_url": "https://support.example.com/support/home",
            },
        )
    ...
    def test_all_health_routes_are_public_in_production_auth_mode(self):
        with patch.object(main, "_auth_required_for_request", return_value=True):
            for path in ("/health", "/health/live", "/health/ready", "/portal/config"):
