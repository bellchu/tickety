...
from app.backend.schema import ResolverCatalogRecommendationResponse
...
class ResolverCatalogRecommendationTests(unittest.TestCase):
    ...
    def _add_ticket(
        ...
        *,
        ...
        ticket = TicketRecord(
            ...
            ai_business_context="JAM",
            ai_routing_scope="multiple_users",
            ai_affected_service="JD Edwards",
            ai_failure_domain="application processing failure",
            ai_routing_reason="JDE rejected a delivered transaction.",
        )
    ...
    def test_recommends_exact_catalog_group_from_current_assignment_observations(self):
        ...
        recommendation = next(
            ...
            if item["resolver_code"] == "APP_JDE"
        )
        self.assertEqual(recommendation["provider_group_id"], "provider-group-100")
        self.assertEqual(recommendation["provider_group_name"], "JDE Resolver Team")
    ...
    def test_content_hash_matches_existing_persistence_helper(self):
        payload = {
            ...
            "affected_service": "JD Edwards – Montréal",
            "failure_domain": "application processing failure",
            "reason": "JDE rejected a delivered transaction.",
        }
