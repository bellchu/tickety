...
# Ticket stats carry the provider-owned resolved/closed timestamps used by
# operational flow metrics. Without them, a synchronized historical closure
# has no trustworthy completion time and must not be placed in the current
# activity window. Keep requester identity in the same bounded list request.
