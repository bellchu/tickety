...
const variantClasses: Record<ButtonVariant, string> = {
  primary:
    "border-transparent bg-ink-700 text-white shadow-sm after:absolute after:inset-x-0 after:bottom-0 after:h-[2px] after:rounded-b-md after:[background:var(--brand-accent)] hover:bg-ink-600",
  secondary:
