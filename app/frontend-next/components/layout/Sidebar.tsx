  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 space-y-1 border-t border-white/10 bg-[#021123] p-3">
        ...
        {(canAccessAdmin || canAccessIntelligence || isDemoWorkspace) && (
          <div role="group" aria-labelledby="nav-admin">
            ...
            <div className="space-y-1">
              ...
              >
                ...
                {canAccessIntelligence && !canAccessAdmin ? "AI settings" : "Settings"}{!canAccessAdmin && !canAccessIntelligence && <span className="sr-only"> (sign in as a demo administrator to manage settings)</span>}
              </Link>
            </div>
          </div>
        )}
        ...
        <div className="mt-2 border-t border-white/10 pt-3">
          ...
          {showLogout && (
            <LogoutButton
              ...
              className="mt-1 w-full justify-start border-transparent px-2.5 text-slate-400 hover:bg-white/[0.035] hover:text-white focus-visible:ring-[#2563EB] focus-visible:ring-offset-[#010D1B]"
            />
          )}
        </div>
      </div>
