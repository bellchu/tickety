    ...
    <div>
      ...
      <div className="flex flex-col sm:flex-row gap-3 mb-5">
        ...
        <select
          ...
          className="px-3 py-2 rounded-lg border border-linen-400 bg-linen-50 text-sm focus:outline-none focus:ring-2 focus:ring-clay-400/30"
        >
          {SORTS.map((s) => (
      ...
      {isLoading ? (
        ...
        <div className="card-surface p-12 text-center">
          <p className="text-ink-400">No tickets match your filters.</p>
        </div>
      ) : (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
