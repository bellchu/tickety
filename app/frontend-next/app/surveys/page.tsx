...
function SendSurveyDialog({ open, tickets, ticketSearch, ticketHasMore, onTicketSearchChange, templates, dependenciesLoading, dependenciesError, dependenciesRetrying, onRetryDependencies, onOpenChange, onSubmit, pending, error }: { open: boolean; tickets: Ticket[]; ticketSearch: string; ticketHasMore: boolean; onTicketSearchChange: (value: string) => void; templates: SurveyTemplate[]; dependenciesLoading: boolean; dependenciesError: boolean; dependenciesRetrying: boolean; onRetryDependencies: () => void; onOpenChange: (open: boolean) => void; onSubmit: (ticketId: string, templateId: number) => void; pending: boolean; error: unknown }) {
