  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-500 mt-1">Your achievements and performance</p>
      </div>
        ...
        <div className="card-surface p-6">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-slate-400 mt-0.5">Tier {me.tier}</p>
            </div>
          ...
          <div className="pt-6 border-t border-slate-100">
            <div className="flex items-center justify-between mb-3">
              <p className="text-sm font-semibold text-slate-700">Impact Points Progress</p>
              <p className="text-2xl font-bold text-slate-700">{me.impact_points}</p>
            </div>
      ...
      <div>
        <h2 className="text-lg font-semibold text-slate-900 mb-4">Recognition Wall</h2>
            ...
            return (
              <motion.div
                ...
                className={cn(
                  ...
                  unlocked ? "ring-1 ring-slate-200" : "opacity-60"
                )}
              >
                <div className={cn(
                  "w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0",
                  unlocked ? "bg-slate-100 text-slate-600" : "bg-slate-50 text-slate-300"
                )}>
                  {unlocked ? ICON_MAP[meta.icon] : <Lock className="w-5 h-5" />}
                </div>
                <div>
                  <p className="text-sm font-semibold text-slate-900">{meta.display_name}</p>
